...
let
  sources = {
    ...
    "electron-to-chromium-1.5.20" = {
      ...
      version = "1.5.20";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.5.20.tgz";
        sha512 = "74mdl6Fs1HHzK9SUX4CKFxAtAe3nUns48y79TskHNAG6fGOlLfyKA4j855x+0b5u8rWJIrlaG9tcTPstMlwjIw==";
      };
    };
    "emoji-regex-8.0.0" = {
      name = "emoji-regex";
    ...
    "tailwindcss-3.4.11" = {
      ...
      version = "3.4.11";
      src = fetchurl {
        url = "https://registry.npmjs.org/tailwindcss/-/tailwindcss-3.4.11.tgz";
        sha512 = "qhEuBcLemjSJk5ajccN9xJFtM/h0AVCPaA6C92jNP+M2J8kX+eMJHI7R2HFKUvvAsMpcfLILMCFYSeDwpMmlUg==";
      };
    };
    "thenby-1.3.4" = {
      name = "thenby";
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."electron-to-chromium-1.5.20"
